...
Version 1.0.0
Project home page: https://github.com/jayluxferro/torshammer
...
userAgents = [
    ...
    "Mozilla/5.0 (compatible; Yahoo! Slurp/3.0; https://help.yahoo.com/help/us/ysearch/slurp)",  # maybe not
...
def usage():
    print("torshammer -t <target> [-r <threads> -p <port> -T -h]")
    ...
    print("Eg. torshammer -t 192.168.1.100 -r 256\n")
